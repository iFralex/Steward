...
import { getLastProject, getRecentProjects, saveLastProject, loadLlmConfig, loadLanguage, loadSearchApiConfig, loadEmbeddingConfig, loadMineruConfig, loadMultimodalConfig, loadOutputLanguage, loadProviderConfigs, loadActivePresetId, loadProxyConfig, loadBackgroundMode, loadScheduledImportConfig, saveScheduledImportConfig, loadSourceWatchConfig, loadApiConfig, loadGeneralConfig, loadZoomLevel, loadBackupConfig, loadBackupStatus } from "@/lib/project-store"
  ...
  useEffect(() => {
    async function init() {
      try {
        ...
        const savedBackupStatus = await loadBackupStatus()
        if (savedBackupStatus) useWikiStore.getState().setBackupStatus(savedBackupStatus)
