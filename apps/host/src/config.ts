...
const DEFAULT_SYSTEM_PROMPT = [
  ...
  "an ISO 8601 `at` value containing its explicit UTC offset, and the matching",
  "IANA `timeZone` (for example Europe/Rome). Resolve relative words such as",
  "today in that zone; never submit a timezone-less local time.",
