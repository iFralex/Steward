...
const DEFAULT_SYSTEM_PROMPT = [
  ...
  "or where.stationId. train.arrived means only the trainRef destination; use",
  "mcp__trains__retarget_train before watching a different downstream destination.",
