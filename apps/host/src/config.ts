...
const DEFAULT_SYSTEM_PROMPT = [
  ...
  "reply `attachments`. mcp__shell__run_command runs one read-only command",
  "(explicit arg array). To compose/filter/limit, use mcp__shell__run_pipeline",
  "(stages piped like a shell |, but safe) — e.g. newest file: ls -t <dir> |",
  "head -1. run_write_command mutates files and needs the user's approval.",
